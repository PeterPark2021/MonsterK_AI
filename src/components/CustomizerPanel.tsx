...
import { 
  ...
  Trash2, Plus, Info, ShieldAlert, Cpu, Award, RefreshCw, BarChart2, Eye, Sliders, Type
} from 'lucide-react';
...
interface CustomizerPanelProps {
  ...
  activeTab: 'wizard' | 'general' | 'theme' | 'phrases' | 'ml';
  setActiveTab: (tab: 'wizard' | 'general' | 'theme' | 'phrases' | 'ml') => void;
}
